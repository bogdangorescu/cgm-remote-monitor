...
// food editor
    ...
    ,'Loading temp basal data' : {    
      ...
      ro: 'Se încarcă bazala temporară'
      }
    ,'Save current record before changing to new?' : {
      cs: 'Uložit současný záznam před změnou na nový?',
      ro: 'Salvați înregistrarea curentă înainte de a face una nouă?'
      }
    ,'Profile Switch' : {
      cs: 'Přepnutí profilu',
      ro: 'Schimbare profil'
    ...
    ,'General profile settings' : {
      ...
      ro: 'Setările profilului general'
      }
    ,'Title' : {
      cs: 'Název',
      ro: 'Titlu'
    ...
    ,'Database records' : {
      ...
      ro: 'Înregistrări din baza de date'
      }
    ,'Add new record' : {
      cs: 'Přidat nový záznam',
      ro: 'Adaugă o înregistrare nouă'
      }
    ,'Remove this record' : {
    ...
    ,'Clone this record to new' : {
      ...
      ro: 'Clonează această înregistrare într-una nouă'
      }
    ,'Record valid from' : {
      cs: 'Záznam platný od',
      ro: 'Înregistrare valabilă începând cu'
      }
    ,'Stored profiles' : {
      cs: 'Uložené profily',
      ro: 'Profile înregistrate'
      }
    ,'Timezone' : {
      cs: 'Časová zóna',
      ro: 'Zona de timp'
    ...
    ,'Duration of Insulin Activity (DIA)' : {
      ...
      ro: 'Durata Acțiunii Insulinei (DIA)'
      }
    ,'Represents the typical duration over which insulin takes effect.  Varies per patient and per insulin type. Typically 3-4 hours for most pumped insulin and most patients. Sometimes also called insulin lifetime.' : {
      ...
      ro: 'Reprezintă durata tipică în care insulina are efect. Variază în funcție de pacient și de tipul de insulină. Valoarea tipică este de 3-4 ore pentru majoritatea pompelor de insulină și a pacienților. Mai este denumită și viața insulinei.'
      }
    ,'Insulin to carb ratio (I:C)' : {
      cs: 'Inzulíno-sacharidový poměr (I:C).',
      ro: 'Raport insulină-carbohidrați (I:C)'
      }
    ,'hours' : {
      cs: 'hodiny',
      ro: 'ore'
    ...
    ,'g carbs per U insulin. The ratio of how many grams of carbohydrates are offset by each U of insulin.' : {
      ...
      ro: 'g de carbohidrați pe 1U de insulină. Câte grame de carbohidrați sunt necesare pentru 1U de insulină.'
      }
    ,'Insulin Sensitivity Factor (ISF)' : {
      cs: 'Citlivost inzulínu (ISF)',
      ro: 'Factor de Sensibilitate a Insulinei (ISF)'
      }
    ,'mg/dL or mmol/L per U insulin. The ratio of how much BG changes with each U of corrective insulin.' : {
      ...
      ro: 'mg/dL sau mmol/L pentru 1U insulină. Cu câte unități variază glicemia pentru 1U de insulină de corecție.'
      }
    ,'Carbs activity / absorption rate' : {
      cs: 'Rychlost absorbce sacharidů',
      ro: 'Activitatea carbohidraților / rata de absorbție'
      }
    ,'grams per unit time. Represents both the change in COB per unit of time, as well as the amount of carbs that should take effect over that time.  Carb absorption / activity curves are less well understood than insulin activity, but can be approximated using an initial delay followed by a constant rate of absorption (g/hr).' : {
      ...
      ro: 'grame pe unitatea de timp. Reprezintă atât schimbarea de COB pe unitatea de timp, cât și cantitatea de carbohidrați ce ar trebui să aibă efect în acel timp. Absorbția de carbohidrați / curba de activitate sunt mai puțin întelese decât activitatea insulinei, dar poate fi aproximată printr-o amânare inițială urmată de o rată constantă de absorbție (g/h).'
      }
    ,'Basal rates [unit/hour]' : {
      cs: 'Bazály [U/hod].',
      ro: 'Rate bazale [U/oră]'
      }
    ,'Target BG range [mg/dL,mmol/L]' : {
      cs: 'Cílový rozsah glykémií [mg/dL,mmol/L]',
      ro: 'Intervalul țintă al glicemie [mg/dL, mmol/L]'
      }
    ,'Start of record validity' : {
      cs: 'Začátek platnosti záznamu',
      ro: 'Începutul valabilității înregistrării'
      }
